...
page = SolaraViz(
    ...
    components=[
        ...
        make_plot_component(["Orchestrator Assigned", "Orchestrator Eligible"], page=2),
        make_plot_component(["Assigned Green Targets", "Assigned Yellow Targets", "Assigned Red Targets"], page=2),
        make_plot_component(["Orchestrator Coverage %"], page=2),
    ],
